...
<Callout type="info">
  ...
  **Official Documentation:** [nextjs.org/docs/app/getting-started/installation](https://nextjs.org/docs/app/getting-started/installation)
</Callout>
