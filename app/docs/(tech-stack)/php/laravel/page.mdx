...
<Callout type="info">
  ...
  **Official Documentation:** [frankenphp.dev/docs/config/](https://frankenphp.dev/docs/config/)
</Callout>
...
* **Doker Hub:** [hub.docker.com/r/dunglas/frankenphp/tags](https://hub.docker.com/r/dunglas/frankenphp/tags)  
**หมายเหตุ** Image adocsdeploy/frankenphp:8.4 เป็นการสร้าง Image จากผู้จัดทำเป็นการติดตั้ง package เพิ่มเติมสำหรับ Laravel
